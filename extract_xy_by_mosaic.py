...
def extract_by_rowcol(df, sample_ids, filepath, file_col, var_name, data_band, mosaic_tx, val_cols, data_type, nodata=None, kernel=False):
    ...
    # Otherwise it should be a real filepath
        ...
        if kernel:
            print 'you entered the if statement',kernel
            if nodata == None:
            ...
            try:
                ...
                print 'you entered the try statement'
            ...
            print 'you entered the else statement and there is likely an issue with vrt files'
            #import pdb; pdb.set_trace()
